...
- если вы работаете через WSL, то нужно включить опцию для ее использования
...
- чтобы выйти из данного режима логов `CTRL + C` и при этом всё остановится 
- чтобы завершить работу -> `docker compose down`
